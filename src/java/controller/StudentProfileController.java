...
public class StudentProfileController implements Serializable {
    ...
    public String getResponse() {
        ...
        response = "<h3>Hello " + theModel.getFirstName() + "</h3><br/>";
    ...
    public String createProfile() {
        theModel.setLatlong(map());
        ProfileDAO aProfileDAO = new ProfileDAOImpl();    // Creating a new object each time.
        int rowCount = aProfileDAO.createStudent(theModel); // Doing anything with the object after this?
...
//            LoginBean a=new LoginBean();
            ...
            try {
                ...
                message.setContent("<center><img src =\"http://s27.postimg.org/rxe9xv1f7/Linked_U.jpg\"><h2>LinkedU&trade;</h2></center>"
                        ...
                        + theModel.getFirstName() + "</p><p><b>Last Name:  </b>" + theModel.getLastName()
                        + "</p><p><b>Email Address:  </b>" + theModel.getEmail() + "</p><p><b>Security Question:  </b>"
